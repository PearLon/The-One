...
<div class="ta1">
			...
			<div class="rightbox">
				...
				<h2 class="mbx">销售出库明细 </h2>

				<div class="cztable">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<th style="text-align: left;" width="5%">销售编号</th>
							<th style="text-align: left;" width="10%">名称</th>
							<th style="text-align: left;" width="5%">药品ID</th>
							<th style="text-align: left;" width="15%">医生ID</th>
							<th style="text-align: left;" width="5%">销售数量</th>
							<th style="text-align: left;" width="15%">销售时间</th>
						</tr>
						<%for(int i=start;i<over;i++) {
                             totalform sale=(totalform)list.get(i);   
                        %>
						<tr>
							<td><center>
									<%=sale.getID() %></center></td>
							<td><center>
									<%=sale.getNAME() %></center></td>
							<td><center>
									<%=sale.getID1() %></center></td>
									<td><center>
									<%=sale.getID2() %></center></td>
							<td><center>
									<%=sale.getNUMBER() %></center></td>
									<td><center>
									<%=sale.getDATE() %></center></td>
						</tr>
						<%} %>
					...
					<table width="90%" border="0" align="center" cellpadding="0"
						...
						<tr align="center">
							...
							<td width="19%">
								<form action="total.do" method="post">
