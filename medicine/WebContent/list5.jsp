...
<div class="ta1">
         ...
         %>
						<tr>
							...
							<td><a
								href="medicine.do?action=searchname&NAME=<%=medicine.getNAME()%>"><center>
										<%=medicine.getNAME() %></center></a></td>
							<td><center>
						...
						<tr align="center">
							...
							<td width="19%">
								<form action="medicine.do" method="post">
									<input type="hidden" name="action" value="searchnd" />
									<%if((number+1)==1){%>
									已是第一页
									<%}else{%>
